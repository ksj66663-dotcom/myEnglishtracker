...
export const TASKS: Task[] = [
  {
    id: 1,
    title: "Vocabulary Review (50 words)",
    ...
    warning:
      "Disable multiple-choice mode. Seeing wrong options plants false memories.",
  },
  {
    id: 2,
  ...
  },
  {
    ...
    warning:
      "One meaning only. Multiple definitions destroy contextual instinct.",
  },
  {
    id: 4,
  ...
  },
  {
    ...
    warning:
      "Still stuck on a sentence? Mark it. Pass 5 is for grammar lookup.",
  },
  {
    id: 6,
